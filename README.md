...
[![License](https://img.shields.io/badge/license-BSD-blue.svg)](https://github.com/rmsj/sqlboiler/blob/master/LICENSE)
[![GoDoc](https://godoc.org/github.com/rmsj/sqlboiler?status.svg)](https://godoc.org/github.com/rmsj/sqlboiler)
...
import (
  ...
  . "github.com/rmsj/sqlboiler/queries/qm"
)
...
```shell
go get -u -t github.com/rmsj/sqlboiler
```
...
Complete documentation is available at http://github.com/rmsj/sqlboiler
...
import . "github.com/rmsj/sqlboiler/queries/qm"
...
For a comprehensive ruleset for `Bind()` you can refer to our [godoc](https://godoc.org/github.com/rmsj/sqlboiler/queries#Bind).
...
by using the [boil.Begin()](https://godoc.org/github.com/rmsj/sqlboiler/boil#Begin) function.
...
The homepage for the [SQLBoiler](https://github.com/rmsj/sqlboiler) [Golang ORM](https://github.com/rmsj/sqlboiler)
generator is located at: https://github.com/rmsj/sqlboiler

## Benchmarks

If you'd like to run the benchmarks yourself check out our [boilbench](https://github.com/rmsj/boilbench) repo.
