...
func TestCombineTypeImports(t *testing.T) {
	...
	imports1 := imports{
		...
		thirdParty: importList{
			`"github.com/rmsj/sqlboiler/boil"`,
		},
	}
...
func TestCombineImports(t *testing.T) {
	...
	a := imports{
		...
		thirdParty: importList{"github.com/rmsj/sqlboiler", "gopkg.in/nullbio/null.v6"},
	}
	b := imports{
		standard:   importList{"os"},
		thirdParty: importList{"github.com/rmsj/sqlboiler"},
	}
	...
	if c.thirdParty[0] != "github.com/rmsj/sqlboiler" && c.thirdParty[1] != "gopkg.in/nullbio/null.v6" {
		t.Errorf("Wanted: github.com/rmsj/sqlboiler, gopkg.in/nullbio/null.v6 got: %#v", c.thirdParty)
	}
}
