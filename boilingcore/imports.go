...
func newImporter() importer {
	...
	imp.Standard = imports{
		...
		thirdParty: importList{
			...
			`"github.com/rmsj/sqlboiler/queries"`,
			`"github.com/rmsj/sqlboiler/queries/qm"`,
			`"github.com/rmsj/sqlboiler/strmangle"`,
		},
	}
	...
	imp.TestStandard = imports{
		...
		thirdParty: importList{
			`"github.com/rmsj/sqlboiler/boil"`,
			`"github.com/rmsj/sqlboiler/randomize"`,
			`"github.com/rmsj/sqlboiler/strmangle"`,
		},
	}
	...
	imp.TestMain = mapImports{
		"postgres": {
			...
			thirdParty: importList{
				`"github.com/pkg/errors"`,
				`"github.com/spf13/viper"`,
				`"github.com/rmsj/sqlboiler/bdb/drivers"`,
				`"github.com/rmsj/sqlboiler/randomize"`,
				`_ "github.com/lib/pq"`,
			},
		},
	...
	imp.BasedOnType = mapImports{
		...
		"types.JSON": {
			thirdParty: importList{`"github.com/rmsj/sqlboiler/types"`},
		},
		"types.BytesArray": {
			thirdParty: importList{`"github.com/rmsj/sqlboiler/types"`},
		},
